...
// Version 2
#define APP_ENDPOINT_AC_V2_OFFSET_HEADER               0
#define APP_ENDPOINT_AC_V2_OFFSET_VERSION              1
#define APP_ENDPOINT_AC_V2_OFFSET_P2P_X_MSB            2
#define APP_ENDPOINT_AC_V2_OFFSET_P2P_X_LSB            3
#define APP_ENDPOINT_AC_V2_OFFSET_P2P_Y_MSB            4
#define APP_ENDPOINT_AC_V2_OFFSET_P2P_Y_LSB            5
#define APP_ENDPOINT_AC_V2_OFFSET_P2P_Z_MSB            6
#define APP_ENDPOINT_AC_V2_OFFSET_P2P_Z_LSB            7
#define APP_ENDPOINT_AC_V2_OFFSET_RMS_X_MSB            8
#define APP_ENDPOINT_AC_V2_OFFSET_RMS_X_LSB            9
#define APP_ENDPOINT_AC_V2_OFFSET_RMS_Y_MSB            10
#define APP_ENDPOINT_AC_V2_OFFSET_RMS_Y_LSB            11
#define APP_ENDPOINT_AC_V2_OFFSET_RMS_Z_MSB            12
#define APP_ENDPOINT_AC_V2_OFFSET_RMS_Z_LSB            13
#define APP_ENDPOINT_AC_V2_OFFSET_RESERVED0            14
#define APP_ENDPOINT_AC_V2_OFFSET_RESERVED1            15
#define APP_ENDPOINT_AC_V2_OFFSET_RESERVED2            16
#define APP_ENDPOINT_AC_V2_OFFSET_RESERVED3            17
#define APP_ENDPOINT_AC_V2_OFFSET_RESERVED4            18
#define APP_ENDPOINT_AC_V2_OFFSET_RESERVED5            19
#define APP_ENDPOINT_AC_V2_OFFSET_RADIO_MSB            20
#define APP_ENDPOINT_AC_V2_OFFSET_RADIO_LSB            21
#define APP_ENDPOINT_AC_V2_OFFSET_TEMPERATURE_MSB   21
#define APP_ENDPOINT_AC_OFFSET_SEQUENCE_COUNTER_MSB 22
#define APP_ENDPOINT_AC_OFFSET_SEQUENCE_COUNTER_LSB 23
...
#define APP_ENDPOINT_AC_V2_VERSION                  (2U)
...
/**
 * @brief Encode given data to given buffer in app format AC Version 2
 * Version 1 splits the 2-byte voltage of version 0 into 1-byte voltage of 8 mV resolution in range 1600 - 3600 mV
 * and puts 1 C resolution signed int of temperature into second byte.
 *
 * @param[out] buffer: uint8_t array with length of 24 bytes.
 * @param[in]  data: Struct containing all necessary information for
